...
casttest_serial!( test_cast_block_number, async |_prj, cmd| {
...
casttest_serial!( test_cast_gas_price, async |_prj, cmd| {
    let _node = PolkadotNode::start().await.expect("failed to start node");
    let url = PolkadotNode::http_endpoint();
...
casttest_serial!( test_cast_basefee, async |_prj, cmd| {
    let _node = PolkadotNode::start().await.expect("failed to start node");
    let url = PolkadotNode::http_endpoint();
...
casttest_serial!( test_cast_block, async |_prj, cmd| {
    let _node = PolkadotNode::start().await.expect("failed to start node");
    let url = PolkadotNode::http_endpoint();
...
casttest_serial!( test_cast_age, async |_prj, cmd| {
    let _node = PolkadotNode::start().await.expect("failed to start node");
    let url = PolkadotNode::http_endpoint();
...
casttest_serial!( test_cast_find_block, async |_prj, cmd| {
    let _node = PolkadotNode::start().await.expect("failed to start node");
    let url = PolkadotNode::http_endpoint();
